...
void OSTaskInit()
{
    ...
    osThreadDef(encodertask, StartENCODERTASK, osPriorityNormal, 0, 256);
    insTaskHandle = osThreadCreate(osThread(encodertask), NULL);
...
__attritute__((noreturn)) void StartENCODERTASK(void const *argument)
{
